<?php
  /*
          File: sftp_pull_class.php
       Created: 07/23/2020
       Updated: 07/23/2020
    Programmer: Cuates
    Updated By: Cuates
       Purpose: Class for all SFTP and Pull interactions
  */

  // Include configuration file
  include ("sftp_pull_config.php");
  ...
  class sftp_pull_class extends sftp_pull_config
  {
    ...
    public function sftp_pull_class()
    {
